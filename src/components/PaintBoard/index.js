  ...
  const mintNFT = async () => {
    ...
    try {
      ...
      try {
        ...
        console.log('nft', nft, mintedTkId.toNumber(), _royalty);
            ...
            <div className={styles.panelRight}>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  disabled={isMinting}
                />
                <div className={styles.lengthIndicator}>{age.length}/20</div>
              </div>
              <div className={styles.formGroup}>
